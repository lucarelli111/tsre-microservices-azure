...
func main() {
	...
	si := grpctrace.StreamServerInterceptor(grpctrace.WithServiceName("shippingservice"))
	ui := grpctrace.UnaryServerInterceptor(grpctrace.WithServiceName("shippingservice"))
